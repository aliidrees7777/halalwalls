...
export function UploadPlaceholder({ className, onClick }: UploadPlaceholderProps) {
  return (
    ...
    >
      <span className="flex size-10 items-center justify-center rounded-full bg-[#3b82f6] text-white shadow-lg shadow-[#3b82f6]/25">
        <Plus className="size-5" strokeWidth={2.5} />
      </span>
      <span className="text-[13px] font-medium text-hw-muted">Add Wallpaper</span>
    </motion.button>
  );
}
