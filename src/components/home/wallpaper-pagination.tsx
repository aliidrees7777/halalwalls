...
export function WallpaperPagination({
  ...
  return (
    <nav
      className="flex flex-wrap items-center justify-center gap-[var(--lp-pagination-gap)] pt-[var(--lp-grid-to-pagination)] pb-[var(--lp-grid-to-pagination)] lg:justify-center lg:pb-0"
